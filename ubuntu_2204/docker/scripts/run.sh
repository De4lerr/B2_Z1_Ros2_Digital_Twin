...
# Checks if the current directory path ends with 'ROS'.
    ...
    # -e "TERM=xterm-256color" \        -> Show colored outputs
    ...
    # ros_ws:humble                     -> Specifies the Docker image to use.
    ...
    docker run -t --rm -it \
        ...
        -v $PWD/ros_ws:/home/ros_ws/ros_ws \
        -v $(cd ..; pwd)/ros_ws_shrd:/home/ros_ws/ros_ws_shrd \
        --workdir /home/ros_ws/ros_ws \
        ros_ws:humble
                      
elif [[ ! $PWD = *ubuntu_2204/docker ]]; then
