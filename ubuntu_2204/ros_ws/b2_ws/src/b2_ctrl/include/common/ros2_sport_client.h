...
const int32_t SPORT_API_ID_ECONOMICGAIT      = 1035;
const int32_t SPORT_API_ID_MOVETOPOS         = 1036;
const int32_t SPORT_API_ID_SWITCHEULERMODE   = 1037;
const int32_t SPORT_API_ID_SWITCHMOVEMODE    = 1038;
...
public:
    ...
    void SwitchEulerMode(unitree_api::msg::Request &req, bool flag);
