...
void SportClient::SwitchEulerMode(unitree_api::msg::Request &req, bool flag)
{
    nlohmann::json js;
    js["data"] = flag;
    req.parameter = js.dump();
    req.header.identity.api_id = SPORT_API_ID_SWITCHEULERMODE;
}
...
void SportClient::SwitchMoveMode(unitree_api::msg::Request &req, bool flag)
{
    ...
    js["data"] = flag;
    req.parameter = js.dump();
    req.header.identity.api_id = SPORT_API_ID_SWITCHMOVEMODE;
}