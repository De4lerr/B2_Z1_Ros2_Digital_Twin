...
: ${AMENT_CURRENT_PREFIX:="/home/ros_ws/ros_ws/b2_ws/src/z1_urdf/install/z1_urdf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/z1_urdf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/z1_urdf/environment/path.sh"
