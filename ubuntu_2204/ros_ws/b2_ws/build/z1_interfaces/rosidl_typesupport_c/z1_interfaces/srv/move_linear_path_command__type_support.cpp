...
static const _MoveLinearPathCommand_Request_type_support_symbol_names_t _MoveLinearPathCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveLinearPathCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveLinearPathCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveLinearPathCommand_Request)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveLinearPathCommand_Request_message_type_support_handle;
}
...
static const _MoveLinearPathCommand_Response_type_support_symbol_names_t _MoveLinearPathCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveLinearPathCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveLinearPathCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveLinearPathCommand_Response)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveLinearPathCommand_Response_message_type_support_handle;
}
...
static const _MoveLinearPathCommand_type_support_symbol_names_t _MoveLinearPathCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveLinearPathCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveLinearPathCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveLinearPathCommand)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveLinearPathCommand_service_type_support_handle;
}
