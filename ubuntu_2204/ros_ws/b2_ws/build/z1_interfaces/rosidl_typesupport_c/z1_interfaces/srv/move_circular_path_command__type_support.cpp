...
static const _MoveCircularPathCommand_Request_type_support_symbol_names_t _MoveCircularPathCommand_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveCircularPathCommand_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveCircularPathCommand_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveCircularPathCommand_Request)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveCircularPathCommand_Request_message_type_support_handle;
}
...
static const _MoveCircularPathCommand_Response_type_support_symbol_names_t _MoveCircularPathCommand_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveCircularPathCommand_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveCircularPathCommand_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveCircularPathCommand_Response)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveCircularPathCommand_Response_message_type_support_handle;
}
...
static const _MoveCircularPathCommand_type_support_symbol_names_t _MoveCircularPathCommand_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, z1_interfaces, srv, MoveCircularPathCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, z1_interfaces, srv, MoveCircularPathCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, z1_interfaces, srv, MoveCircularPathCommand)() {
  return &::z1_interfaces::srv::rosidl_typesupport_c::MoveCircularPathCommand_service_type_support_handle;
}
