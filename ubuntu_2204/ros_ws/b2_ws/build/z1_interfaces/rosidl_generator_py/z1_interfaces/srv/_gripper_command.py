...
class GripperCommand_Request(metaclass=Metaclass_GripperCommand_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.gripper_w = kwargs.get('gripper_w', float())
        self.gripper_tau = kwargs.get('gripper_tau', float())
    ...
    def __eq__(self, other):
        ...
        if self.gripper_pos != other.gripper_pos:
            return False
        if self.gripper_w != other.gripper_w:
            return False
        if self.gripper_tau != other.gripper_tau:
            return False
        return True
    ...
    @builtins.property
    def gripper_w(self):
        """Message field 'gripper_w'."""
        return self._gripper_w

    @gripper_w.setter
    def gripper_w(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gripper_w' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'gripper_w' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._gripper_w = value

    @builtins.property
    def gripper_tau(self):
        """Message field 'gripper_tau'."""
        return self._gripper_tau

    @gripper_tau.setter
    def gripper_tau(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'gripper_tau' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'gripper_tau' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
...
class Metaclass_GripperCommand(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'z1_interfaces.srv.GripperCommand')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from z1_interfaces.srv import _gripper_command
...
class GripperCommand(metaclass=Metaclass_GripperCommand):
    from z1_interfaces.srv._gripper_command import GripperCommand_Request as Request
    from z1_interfaces.srv._gripper_command import GripperCommand_Response as Response
